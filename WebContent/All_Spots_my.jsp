...
<button id="toggle_weather">Weather</button>
		...
		else if("upload".equals(action))
		{
		  	String idStr1 = request.getParameter("spotid");
		  	Integer spot_id = Integer.parseInt(idStr1);	
		  	session.setAttribute("spotid", spot_id);
		  	response.setHeader("refresh","0.5;URL=writeArticle.jsp"); 
   ...
   <tr>
	...
	<% } 
  	...
  	<td>
  	<a href="wirteArticle.jsp&action=upload&spotid=<%=spot.getId()%>" class="btn btn-info">UpLoad Information</a>
  	</td>
