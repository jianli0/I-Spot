...
<body>
    ...
    if("submit".equals(action))
    {
    	...
    	Article art = new Article(null, spot, content, "A");
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="well">
                    ...
                    <form role="form" action="Upload.jsp">
                        <div class="form-group">
                        	<input type="hidden"  class="form-control" name="spot_id" value="<%=sid %>"></input>
                        	<input class="form-control" placeholder ="please type here" rows="3" name="content"></input>
                        </div>
